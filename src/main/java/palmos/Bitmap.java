...
public class Bitmap {
    ...
    /** BitmapFlag Contstants - these values or ORed together in the field BitmapFlag<br>
     *  Data format:  0=raw; 1=compressed */
    public final static short BITMAPFLAGSTYPE_COMPRESSED = 0x0001;
    
    /** if true, color table stored before bits[] */
    public final static short BITMAPFLAGSTYPE_hasColorTable = 0x0002;
  
    /** true if transparency is used */
    public final static short BITMAPFLAGSTYPE_hasTransparency = 0x0004;
 
    /** true if bits are stored indirectly */
    public final static short BITMAPFLAGSTYPE_indirect = 0x0008;
 
    /** system use only */
    public final static short BITMAPFLAGSTYPE_forScreen = 0x0010;
